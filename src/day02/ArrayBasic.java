...
public class ArrayBasic {
    public static void main(String[] args) {
        ...
        // 1. 배열 변수 선언
        int[] numbers; //정수타입 x 정수배열타입 o

        // 2. 배열의 객체를 생성
        numbers = new int[5]; //몇개 저장할건지 미리 정하기
        System.out.println("numbers = " + numbers);
        // 3. 배열 값 초기화
        numbers[0] = 50;
        numbers[1] = 77;
        numbers[2] = (int)66.7; //66만 저장됨
        numbers[3] = numbers[0] + 20;
        numbers[4] = 100;
//        numbers[5] = 10; 5개 이상 사용 x
...
//            System.out.println("n = " + n);
        ...
        // new Type[] 생략 가능
        String[] pets = {"멍멍이", "짹짹이", "콩수니"}; //배열 변수 선언과 동시에 초기화할때만 생략 가능
